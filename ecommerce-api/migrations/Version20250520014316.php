 ...
 */
final class Version20250520014316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE product ADD category_id INT NOT NULL, DROP ctegory, CHANGE description description LONGTEXT NOT NULL, CHANGE price price DOUBLE PRECISION NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE product ADD ctegory VARCHAR(255) NOT NULL, DROP category_id, CHANGE description description VARCHAR(255) NOT NULL, CHANGE price price INT NOT NULL
        SQL);
    }
}
